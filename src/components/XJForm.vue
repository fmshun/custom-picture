...
const channelOpions = ref(constant.XJ_CHANNEL);
const teams = ref(constant.XJ_LOGO);
...
const getImg = (item: string) => {
  return new URL(`../assets/img/XJ_CHANNEL/${item}.png`, import.meta.url).href;
};
