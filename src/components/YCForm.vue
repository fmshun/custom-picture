    ...
    >
      <el-carousel-item v-for="(item, k) in ruleForm.channels" :key="k">
        ...
        >
          ...
          <div
            class="haixin-title which-round"
...
const channelOpions = ref(constant.YC_CHANNEL);
const teams = ref(constant.YC_LOGO);
...
const getImg = (item: string) => {
  return new URL(`../assets/img/YC_CHANNEL/${item}.png`, import.meta.url).href;
};
