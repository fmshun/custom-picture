...
const channelOpions = ref(constant.FJ_CHANNEL);
const teams = ref(constant.FJ_LOGO);
...
const getImg = (item: string) => {
  return new URL(`../assets/img/FJ_CHANNEL/${item}.png`, import.meta.url).href;
};
