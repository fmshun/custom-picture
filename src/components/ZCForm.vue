...
const channelOpions = ref(constant.ZC_CHANNEL);
const teams = ref(constant.ZC_LOGO);
...
const getImg = (item: string) => {
  return new URL(`../assets/img/ZC_CHANNEL/${item}.png`, import.meta.url).href;
};
