    ...
    >
      <el-carousel-item v-for="(item, k) in ruleForm.channels" :key="k">
        ...
        >
          ...
          <div
            class="huawei-home-title which-round"
...
const channelOpions = ref(constant.DJ_CHANNEL);
const teams = ref(constant.DJ_LOGO);
...
const getImg = (item: string) => {
  return new URL(`../assets/img/DJ_CHANNEL/${item}.png`, import.meta.url).href;
};
